...
<div class="bg-gray-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2">
    ...
    <div class="p-6">
        <div class="ml-12">
            ...
            <div class="mt-6 text-sm text-gray-500">
                <img class="inline object-cover w-24 h-24 mr-4" src="{{ asset(auth()->user()->profile_url) }}" alt="Profile image"/>
                <img class="inline object-cover w-16 h-16 mr-4" src="{{ asset(auth()->user()->profile_url) }}" alt="Profile image"/>
                <img class="inline object-cover w-12 h-12 mr-4" src="{{ asset(auth()->user()->profile_url) }}" alt="Profile image"/>
                <img class="inline object-cover w-8 h-8 mr-4" src="{{ asset(auth()->user()->profile_url) }}" alt="Profile image"/>
            </div>
            ...
            <div class="mt-6 -space-x-4">
                ...
                <img class="relative z-10 inline object-cover w-12 h-12 border-2 border-white rounded-full" src="{{ asset(auth()->user()->profile_url) }}" alt="Profile image"/>
            </div>

            <div class="mt-6 text-sm text-gray-500">
                <div class="relative inline-block">
                    <img class="inline-block object-cover w-16 h-16 rounded-full" src="{{ asset(auth()->user()->profile_url) }}" alt="Profile image"/>
